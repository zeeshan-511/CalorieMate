...
class PreferenceApiService {
  ...
  static Future<bool> savePreferences({
    ...
    debugPrint('Save preferences status: ${response.statusCode}');
    debugPrint('Save preferences body: ${response.body}');
  ...
  static Future<UserPreferences?> getPreferences({
    ...
    final uri =
        Uri.parse('$kApiBaseUrl/api/preferences/$userId?memberId=$memberId');
...
class FamilyMemberApiService {
  ...
  static Future<Map<String, dynamic>?> addFamilyMember({
    ...
    final uri = Uri.parse('$kApiBaseUrl/family-members');
    ...
    try {
      ...
      if (response.statusCode == 200 || response.statusCode == 201) {
        ...
        if (decoded is Map<String, dynamic>) {
          if (decoded['member'] is Map<String, dynamic>) {
            return decoded['member'] as Map<String, dynamic>;
          }
          return decoded;
        }
      }
      ...
      debugPrint('Add family member exception: $e');
      return null;
    }
  }
  ...
  static Future<List<Map<String, dynamic>>> getFamilyMembers({
    ...
    final uri = Uri.parse('$kApiBaseUrl/family-members/$userId');
    ...
    try {
      ...
      debugPrint('Get members body: ${response.body}');
      ...
      debugPrint('Get family members exception: $e');
      return [];
    }
  }
}
...
class _ConfirmationHeader extends StatelessWidget {
  ...
  const _ConfirmationHeader({required this.memberName});
...
class PreferencesStartScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return SimplePreferencesEditor(
      title: '$memberName Preferences',
      subtitle:
          'Choose the food rules and health goals that should be used when recommending products for $memberName.',
      dietary: dietary,
                      ...
                      children: [
                        Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            borderRadius: BorderRadius.circular(14),
                            border:
                                Border.all(color: kPrimary.withOpacity(0.12)),
                          ),
                          child: Row(
                            children: [
                              ...
                              Expanded(
                                child: Text(
                                  'Selecting preferences for ${widget.memberName}',
                                  maxLines: 1,
                                  overflow: TextOverflow.ellipsis,
                                  style: const TextStyle(
                                      color: kPrimary,
...
class AllergensPreferencesScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return _PreferenceStepScaffold(
      ...
      subtitle:
          "Select allergens this family member should avoid. Example: Milk will trigger warnings for lactose or dairy ingredients.",
...
class AdditivesPreferencesScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return _PreferenceStepScaffold(
      ...
      subtitle:
          "Choose additives this member should avoid or limit. Example: Artificial Colors lowers scores for colorant-heavy products.",
...
class DietPreferencesScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return _PreferenceStepScaffold(
      ...
      subtitle:
          'Select dietary rules for this member. Example: Halal makes halal status essential before recommending a product.',
      sectionLabel: 'Diet',
      items: const [
        'Halal',
        'Vegetarian',
...
class IngredientsPreferencesScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return _PreferenceStepScaffold(
      ...
      subtitle:
          'Select ingredients this member wants to avoid or monitor during scans.',
...
class NutritionalPreferencesScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return _PreferenceStepScaffold(
      ...
      subtitle:
          'Choose nutrition goals used to score this member’s products. Example: Low Sugar penalizes high-sugar products.',
                ...
                child: SingleChildScrollView(
                  ...
                  child: _PreferenceFormCard(
                    child: Column(
                      ...
                      children: [
                        Text(
                          'These settings personalize recommendations for ${widget.memberName}.',
                          style: const TextStyle(
                              color: kTextMid, fontSize: 13, height: 1.35),
                        ),
                        const SizedBox(height: 18),
                        _AdvancedGroup(
                          ...
                          description:
                              'Examples: diabetes, hypertension, cholesterol, celiac disease.',
                          items: const [
                            'Diabetes',
                            'Hypertension',
                            'High Cholesterol',
                        ...
                        _AdvancedGroup(
                          ...
                          description:
                              'Products with these ingredients receive positive notes.',
                          items: const [
                            'Whole Grain',
                            'Oats',
                            'Almonds',
                        ...
                        _AdvancedGroup(
                          ...
                          description:
                              'Control how strict the AI should be for this member.',
                          items: const [
                            'Strict Mode',
...
class ConfirmationScreen extends StatelessWidget {
          ...
          child: Column(
            children: [
              _PrefsAppBar(
                  memberName: memberName,
                  onBackPressed: () => Navigator.pop(context)),
              _ConfirmationHeader(memberName: memberName),
              Expanded(
                child: SingleChildScrollView(
                  padding: const EdgeInsets.fromLTRB(16, 18, 16, 26),
                  child: Column(
                    children: [
                      _buildMemberSummary(memberName),
                      const SizedBox(height: 14),
                          ...
                          onPressed: () async {
                            ...
                            if (success) {
                              messenger.showSnackBar(
                                const SnackBar(
                                    content: Text(
                                        'Family preferences saved successfully.')),
                              );
                              await showDialog<void>(
                                context: context,
                                builder: (dialogContext) => AlertDialog(
                                  title: const Text('Family profile ready'),
  ...
  Widget _buildMemberSummary(String memberName) {
    return Container(
      width: double.infinity,
      ...
      child: Row(
        children: [
          Container(
            ...
            height: 42,
            decoration: const BoxDecoration(
                color: kChipUnselected, shape: BoxShape.circle),
  ...
  String _feedbackText() {
    ...
    return strict
        ? 'Future scans for $memberName will use strict checks for OCR ingredients, halal status, allergens, nutrition, and category match.'
        : 'Future scans for $memberName will balance ingredient safety, nutrition values, halal status, and similar product alternatives.';
  }
}
